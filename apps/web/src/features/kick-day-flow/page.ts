...
import { getDayFlowPayload } from "./adapter"
...
export function renderDayFlowPage(root: HTMLElement): void {
  ...
  root.innerHTML = `
    ${renderHeader("day-flow", kickSiteConfig)}
    ${renderHero({
      eyebrow: "TODAY",
      title: "Day Flow",
      ...
      actions: [
        { href: "/kick/heatmap/", label: "Heatmap (support)" },
...
export { renderDayFlowPage as renderKickDayFlowPage }
